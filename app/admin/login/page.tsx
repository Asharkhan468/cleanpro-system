            ...
            <form onSubmit={userLogin} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Email"
                  required
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 font-poppins text-base md:text-lg outline-none focus:border-teal-600 focus:ring-1 focus:ring-teal-600 transition-colors bg-white"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 pt-2">
                  ...
                  />
                  <label htmlFor="remember" className="text-base md:text-lg font-poppins text-gray-700 cursor-pointer">
                    Remember me
                  </label>
                </div>
              </div>
